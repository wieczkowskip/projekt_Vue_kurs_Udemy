<template>
  <base-dialog v-if="inputIsInvalid" title="Invalid input" @close="confirmError">
    <template #default>
      ...
      <p>Inputs can't be empty. Please check and correct your inputs.</p>
    </template>
    <template #actions> 
...
export default {
  ...
  methods: {
    submitData() {
      ...
      this.addNewResource(this.newTitle, this.newDescription, this.newLink);
      this.newTitle = this.newDescription = this.newLink = ''
    },
    confirmError(){
